...
public class JwtAuthTokenFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JwtAuthTokenFilter(JwtProvider tokenProvider, OwlUserDetailsService owlUserDetailsService) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            if (jwt != null && tokenProvider.validateJwtToken(jwt)) {
                ...
                UserDetails userDetails = owlUserDetailsService.loadUserByUsername(username);
